...
public class BBSController {
	...
	public String bbs_tag(@ModelAttribute("bbsVO") BoardVO boardVO, HttpSession session, Model model) {
		MemberVO memberVO = (MemberVO) session.getAttribute("login_info");
		if (memberVO != null) {
			boardVO.setB_userid(memberVO.getM_userid());
		} else {
			boardVO.setB_userid("**@###.com");
		}
	...
	public String bbs_write(@ModelAttribute("bbsVO") BoardVO boardVO, HttpSession session, Model model) {
		MemberVO memberVO = (MemberVO) session.getAttribute("login_info");
		if (memberVO == null) {
	...
	public String bbs_write(@ModelAttribute("bbsVO") BoardVO boardVO, BindingResult result, Model model,
	...
	public String write_tag(@ModelAttribute("bbsVO") BoardVO boardVO, BindingResult result,
	...
	public String bbs_view(@ModelAttribute("bbsVO") BoardVO boardVO, Model model, HttpSession session) {
		MemberVO membervo = (MemberVO) session.getAttribute("login_info");
		if (membervo == null) {
			model.addAttribute("LOGIN_MSG", "LOGIN_REQ");
			return "redirect:/login/login";
